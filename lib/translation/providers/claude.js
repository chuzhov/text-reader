...
Set "isWord" to false if the input is not a real ${sourceLang} word (e.g. random letters, gibberish, abbreviations without meaning). Include up to 5 alternative translations if they exist. First item must be the most contextually appropriate.`
